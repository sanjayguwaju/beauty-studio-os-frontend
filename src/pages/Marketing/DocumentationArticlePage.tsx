    ...
    <div className="bg-white dark:bg-gray-900 min-h-screen pb-24">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 mt-12">
        <article className="prose prose-lg dark:prose-invert prose-brand max-w-none">
          <p className="lead">
            Role-Based Access Control (RBAC) is a method of restricting network access based on the roles of individual users within an enterprise. In BeautyStudio OS, RBAC ensures that municipal staff only have access to the information and actions necessary for their specific jobs.
          </p>

          <h2>Core Concepts</h2>
          <p>
            BeautyStudio OS utilizes three main components for its permission system:
          </p>
          <ul>
          ...
          <h2>Default Roles</h2>
          <p>
            When you register your municipality on BeautyStudio OS, several default roles are automatically provisioned:
          </p>
