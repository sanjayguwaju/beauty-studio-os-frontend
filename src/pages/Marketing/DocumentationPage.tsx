...
const categories = [
  {
    ...
    description: "Learn the basics of BeautyStudio OS and set up your municipality profile.",
    icon: BookOpen,
  ...
  {
    title: "Developer API",
    description: "Integrate BeautyStudio OS with third-party tools using our REST API.",
    icon: Code,
      ...
      <div className="bg-brand-50 dark:bg-brand-900/10 pt-24 pb-16">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-400 mb-10 max-w-2xl mx-auto">
            Search our knowledge base or browse categories to learn how to configure and use BeautyStudio OS effectively.
          </p>
