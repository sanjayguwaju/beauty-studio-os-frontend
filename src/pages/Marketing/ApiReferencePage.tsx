        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-400 leading-relaxed">
              Integrate your external systems with BeautyStudio OS using our secure REST API. Build custom workflows, sync data, and automate municipal operations.
            </p>
          </div>
        </div>
      </div>
            ...
            <section>
              ...
              <div className="bg-gray-50 dark:bg-gray-800/50 rounded-2xl p-4 sm:p-5 border border-gray-200 dark:border-gray-700 flex items-center justify-between group">
                <code className="text-brand-600 dark:text-brand-400 font-mono text-sm sm:text-base font-semibold">
                  https://api.beautystudioos.com/v1
                </code>
                <button 
                  onClick={() => handleCopy("https://api.beautystudioos.com/v1")}
...
<span className="text-pink-400 font-semibold">curl</span> https://api.beautystudioos.com/v1/users \
...
&#123;
  ...
  <span className="text-blue-300">"data"</span>: [
    &#123;
      ...
      <span className="text-blue-300">"email"</span>: <span className="text-green-300">"admin@beautystudioos.com"</span>,
