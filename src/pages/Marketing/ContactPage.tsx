  ...
  return (
    <div className="py-24 bg-white dark:bg-gray-900 min-h-screen">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p className="text-lg text-gray-600 dark:text-gray-400 mb-12">Have questions about BeautyStudio OS? Our team is here to help you digitally transform your municipality.</p>
