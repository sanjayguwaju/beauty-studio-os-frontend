...
export default function Badges() {
  return (
    <div>
      <PageMeta
        title="React.js Badges Dashboard | BeautyStudio OS - React.js Admin Dashboard Template"
        description="This is React.js Badges Dashboard page for BeautyStudio OS - React.js Tailwind CSS Admin Dashboard Template"
      />
