...
export default function Avatars() {
  return (
    <>
      <PageMeta
        title="React.js Avatars Dashboard | BeautyStudio OS - React.js Admin Dashboard Template"
        description="This is React.js Avatars Dashboard page for BeautyStudio OS - React.js Tailwind CSS Admin Dashboard Template"
      />
