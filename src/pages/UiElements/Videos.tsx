...
export default function Videos() {
  return (
    <>
      <PageMeta
        title="React.js Videos Tabs | BeautyStudio OS - React.js Admin Dashboard Template"
        description="This is React.js Videos page for BeautyStudio OS - React.js Tailwind CSS Admin Dashboard Template"
      />
