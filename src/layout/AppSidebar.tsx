...
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    path: "#",
    subItems: [
      { name: "Courses", path: "/academy/courses", pro: false },
      { name: "Batches", path: "/academy/batches", pro: false },
      { name: "Attendance", path: "/academy/attendance", pro: false },
      { name: "Cert. Rules", path: "/academy/certification-rules", pro: false },
      { name: "Batch Progress", path: "/academy/batch-progress", pro: false },
      { name: "My Progress", path: "/academy/my-progress", pro: false },
      { name: "AI OCR Intake", path: "/academy/ai-ocr", pro: false },
    ],
  },
  {
    icon: <CalenderIcon />,
  ...
  },
  {
    ...
    subItems: [
      ...
      { name: "Commissions", path: "/billing/commissions", pro: false },
    ],
  },
  {
    icon: <ChatIcon />,
    ...
    path: "#",
    subItems: [
      { name: "Comms Center", path: "/notifications/communication-center", pro: false },
      { name: "Templates", path: "/notifications/templates", pro: false },
      { name: "Logs", path: "/notifications/logs", pro: false },
    ],
  },
  {
    icon: <UserIcon />,
