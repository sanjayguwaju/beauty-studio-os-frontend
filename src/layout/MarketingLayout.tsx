    ...
    <div className="min-h-screen bg-white dark:bg-gray-900 flex flex-col">
          ...
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-2">
              <Link to="/" className="flex items-center space-x-2">
                ...
                <span className="text-xl font-bold text-gray-900 dark:text-white tracking-tight">Beauty<span className="text-brand-500">StudioOS</span></span>
              </Link>
            </div>
            {/* Desktop Navigation */}
            <div className="hidden md:flex items-center space-x-6">
              ...
              <Link to="/portal/client" className="text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white px-3 py-2 text-sm font-medium transition-colors">
                Client Portal
              </Link>
            </div>
            ...
            <div className="hidden md:flex items-center space-x-4">
              ...
              <Link to="/signup" className="bg-brand-500 hover:bg-brand-600 text-white px-5 py-2 rounded-full text-sm font-medium transition-colors shadow-sm shadow-brand-500/20">
                Start Free Trial
              </Link>
            </div>
      ...
      <div className={`fixed inset-y-0 right-0 z-70 w-72 bg-white dark:bg-gray-900 shadow-2xl transform transition-transform duration-300 ease-in-out md:hidden flex flex-col ${isMobileMenuOpen ? "translate-x-0" : "translate-x-full"}`}>
        <div className="p-4 border-b border-gray-200 dark:border-gray-800 flex justify-between items-center">
          <span className="text-xl font-bold text-gray-900 dark:text-white">Beauty<span className="text-brand-500">StudioOS</span></span>
          <button 
            onClick={() => setIsMobileMenuOpen(false)}
        ...
        <div className="flex-1 overflow-y-auto px-4 py-6 space-y-4">
          ...
          <Link to="/portal/client" onClick={() => setIsMobileMenuOpen(false)} className="block px-3 py-3 text-base font-medium text-gray-900 dark:text-white hover:bg-gray-50 dark:hover:bg-gray-800 rounded-lg transition-colors">
            Client Portal
          </Link>
        </div>
        ...
        <div className="p-4 border-t border-gray-200 dark:border-gray-800 space-y-3 bg-gray-50 dark:bg-gray-800/50">
          ...
          <Link to="/signup" className="w-full flex justify-center items-center bg-brand-500 hover:bg-brand-600 text-white px-5 py-3 rounded-xl text-base font-medium transition-colors shadow-sm shadow-brand-500/20">
            Start Free Trial
          </Link>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400 max-w-sm mb-6 leading-relaxed">
              The all-in-one SaaS platform for beauty studios, academies, and wellness brands. Manage clients, bookings, billing, and your team from one place.
            </p>
            <p className="text-sm text-gray-400 dark:text-gray-500">
              &copy; {new Date().getFullYear()} BeautyStudio OS Technologies. All rights reserved.
            </p>
          </div>
          <div>
            ...
            <ul className="space-y-3 text-sm text-gray-500 dark:text-gray-400">
              ...
              <li><Link to="/portal/client" className="hover:text-brand-500 transition-colors">Client Portal</Link></li>
            </ul>
          </div>
          <div>
